...
static NSMutableDictionary * createFontStylingDictionary(float textsize) {
    ...
    [myDictionary setObject:[NSColor redColor] forKey:NSForegroundColorAttributeName];

    // about 5% kerning tightening
...
- (void)animateOneFrame
{
    ...
    // Need to figure out how big to make the clock text.
